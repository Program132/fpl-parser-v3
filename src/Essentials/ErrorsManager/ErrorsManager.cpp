...
CREATE_ERROR(CONVERT_StringToInt, "Votre variable de type texte ne peut pas devenir un entier car elle ne contient pas un entier en valeur, ligne ", 14)
CREATE_ERROR(CONVERT_StringToDouble, "Votre variable de type texte ne peut pas devenir un nombre decimal car elle ne contient pas un nombre decimal en valeur, ligne ", 15)
